...
const items: Item[] = [
  ...
  { id: "quickfilter-atom", label: "QuickFilter (atom)", component: QuickFilterAtomShowcase, tags: ["depth:0", "form"] },
  { id: "worker-card", label: "WorkerCard", component: WorkerCardShowcase, tags: ["depth:0", "container", "indicator"] },
  { id: "work-progress-card", label: "WorkProgressCard", component: WorkProgressCardShowcase, tags: ["depth:0", "container", "indicator", "data", "time"] },
  { id: "split-queue-list", label: "SplitQueueList", component: SplitQueueListShowcase, tags: ["depth:0", "list", "navigation", "container"] },
  { id: "sortable-list", label: "SortableList", component: SortableListShowcase, tags: ["depth:0", "list", "form", "container"] },
  { id: "mutable-list", label: "MutableList", component: MutableListShowcase, tags: ["depth:1", "list", "form", "container"] },
