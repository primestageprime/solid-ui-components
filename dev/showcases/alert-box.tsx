...
export const AlertBoxShowcase: Component<Depth2Props> = (props) => {
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Composes Surface + Layout + Text (curried). Status-colored alert with
        ...
        <div class="depth2-atoms">
          ...
          <div class="depth2-atom-group">
            ...
            >
              ...
              <InfoSurface>
                <TextBody>padding: md, radius: md, info colors</TextBody>
              </InfoSurface>
            </div>
            <div
              class="depth2-atom depth2-atom--link"
            ...
            >
              ...
              <WarningSurface>
                <TextBody>padding: md, radius: md, warning colors</TextBody>
              </WarningSurface>
            </div>
            <div
              class="depth2-atom depth2-atom--link"
            ...
            >
              ...
              <SuccessSurface>
                <TextBody>padding: md, radius: md, success colors</TextBody>
              </SuccessSurface>
            </div>
            <div
              class="depth2-atom depth2-atom--link"
            ...
            >
              ...
              <DangerSurface>
                <TextBody>padding: md, radius: md, danger colors</TextBody>
              </DangerSurface>
            </div>
          </div>
          <div class="depth2-atom-group">
            ...
            >
              ...
              <div class="text-meta">
                align: center, justify: between, gap: md
              </div>
            </div>
            <div
              class="depth2-atom depth2-atom--link"
