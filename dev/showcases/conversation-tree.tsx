...
const flatMessages: ConversationMessage[] = [
  { id: "1", participantId: "peter", timestamp: d(2), text: "Kicking off the rendering pipeline review. The goal this week is to land the deferred-pass refactor and have the new heightfield LOD transitions verified across the four reference scenes. Please drop notes here as you find things." },
  { id: "2", participantId: "alex", timestamp: h(20), text: "I have notes on the heightfield pass." },
  { id: "3", participantId: "alex", timestamp: h(20) + 30_000, text: "Specifically the LOD transitions — the popping at the 64m boundary is back. I think it's the morph factor being clamped too early when the camera dolly is fast; we lose a frame or two of blend on quick approach." },
  { id: "4", participantId: "morgan", timestamp: m(45), text: "Posting numbers from yesterday's run." },
  { id: "5", participantId: "morgan", timestamp: m(45) + 60_000, text: "Frame time held at 4.2ms p99." },
  { id: "6", participantId: "morgan", timestamp: m(44), text: "GPU bound on the second deferred pass — same as last week. The shadow cascade resolve looks like the next thing worth attacking; it's spending ~1.1ms on the medium scene and barely moves between low and high settings, which suggests we're fill-bound rather than vertex-bound." },
  { id: "7", participantId: "peter", timestamp: m(8), text: "Nice. Can we re-run with the new tiling? Curious whether the L2 hit rate improvement we measured on the synthetic benchmark actually shows up in the cascade resolve, or if we're just getting lucky on the easy paths." },
  { id: "8", participantId: "alex", timestamp: m(2), text: "Queued — should land tonight." },
  {
    id: "9",
...
const treeMessages: ConversationMessage[] = [
  { id: "r1", participantId: "peter", timestamp: h(3), text: "Should we ship the new heatstream rollup before the demo?" },
  { id: "r2", participantId: "alex", timestamp: h(3) + 5 * 60_000, text: "I'd hold — the partial-status edge case isn't covered.", replyToId: "r1" },
  { id: "r3", participantId: "morgan", timestamp: h(3) + 8 * 60_000, text: "Agreed with Alex. Demo path doesn't hit it but support will.", replyToId: "r2" },
  { id: "r4", participantId: "peter", timestamp: h(2) + 30 * 60_000, text: "Fine. What's the smallest scope that closes it?", replyToId: "r3" },
  { id: "r5", participantId: "alex", timestamp: h(2), text: "One predicate change in the rollup reducer + a fixture.", replyToId: "r4" },
  { id: "r6", participantId: "alex", timestamp: h(2) + 30_000, text: "I can have it up in an hour.", replyToId: "r4" },
  { id: "r7", participantId: "sam", timestamp: m(20), text: "Separately — the demo deck needs a new slide for this.", replyToId: "r1" },
  { id: "r8", participantId: "morgan", timestamp: m(15), text: "I'll take that.", replyToId: "r7" },
];
      ...
      <div class="depth2-layout">
        <div class="depth2-composed">
          ...
          <p class="text-meta">
            ...
            for Alex's pair 30s apart. Day divider separates yesterday from today.
            Peter is the current user, so his bubbles render right-aligned.
          </p>
          <ConversationTree
        ...
        <div class="depth2-atoms">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">vertical group of message rows + bubble stack</div>
            </div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">Row</div>
              <div class="text-meta">avatar + body row; reversed for current user</div>
            </div>
          </div>
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">relative time-since with full-timestamp tooltip</div>
            </div>
          </div>
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">relative age formatting (3s / 4m / 2h / …)</div>
            </div>
          </div>
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">initials circle, image fallback via avatarUrl</div>
            </div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">MessageBubble</div>
              <div class="text-meta">tinted bubble, 5-line clamp + (more…), 20-line scroll cap</div>
            </div>
          </div>
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">muted cool palette (HSL 185–260, S 32–45, L 60–67)</div>
            </div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">grouping</div>
              <div class="text-meta">same author + same depth + within groupWithinMs (5min default)</div>
            </div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">dividers</div>
              <div class="text-meta">day change OR gap &gt; absoluteAfterMs (1h default)</div>
            </div>
          </div>
        </div>
      </div>
