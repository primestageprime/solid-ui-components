...
export const DataListShowcase: Component<Depth2Props> = (props) => {
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Composes Cell + Text (curried) + StatusBadge (Atomic). Semantic
        key-value table with DTable, DT, DD, Val, Units, SigFig.
      </p>
      <div class="depth2-layout">
        <div class="depth2-composed">
          ...
          <DTable>
            <DT>Vessel</DT>
            <DD primary>PACIFIC VOYAGER</DD>
            <DT>Asset</DT>
            <DD>A-1042</DD>
            <DT>Status</DT>
            <DD success>Active</DD>
            <DT>Duration</DT>
            <DD highlight>48h 12m</DD>
            <DT muted>Notes</DT>
          ...
          <DTable>
            ...
            <DT>Engine</DT>
            <DD>
              <Val value={1200} precision={0} />
              <Units>kW</Units>
            </DD>
            <DT>Precision</DT>
            <DD>
              <SigFig value={0.004218} figures={3} />
            </DD>
          </DTable>
          ...
          >
            <DRow border>
              <DT>Temperature</DT>
              <DD>
                <NumberWithUnits value={72.4} units="°F" precision={1} />
              </DD>
            </DRow>
            <DRow border>
              <DT>Humidity</DT>
              <DD>
                <NumberWithUnits value={45} units="%" />
              </DD>
            </DRow>
            <DRow border highlight>
              <DT>Pressure</DT>
              <DD highlight>
                <NumberWithUnits value={29.92} units="inHg" precision={2} />
              </DD>
            </DRow>
          </DTableWithHeader>
        </div>
        <div class="depth2-atoms">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">
                table wrapper — border-collapse, 0.75rem
              </div>
            </div>
            <div class="depth2-atom">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">
                value td — highlight / success / primary / muted
              </div>
            </div>
            <div class="depth2-atom">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">
                Badge wraps StatusBadge with variant map
              </div>
            </div>
          </div>
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              ...
              <div class="text-meta">
                toPrecision(figures) with null fallback
              </div>
            </div>
          </div>
          <h3>Depth 2</h3>
          <div class="depth2-atom-group">
            ...
            >
              ...
              <div class="text-meta">
                preferred over Val + Units for new code
              </div>
            </div>
          </div>
        </div>
