...
export const DataTableContainerShowcase: Component = () => {
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Owns CSS (DataTableContainer.css), no component imports. Scrollable
        container with max-height or flex-fill.
      </p>
      ...
      <div class="example-group">
        ...
        <Stack gap="sm">
          <div>
            ...
            <div class="text-meta">
              Apply to thead — sticky top: 0, z-index: 10, dark bg
            </div>
          </div>
          <div>
            <code class="text-meta">.sticky-row-header</code>
            <div class="text-meta">
              Apply to first-column th — sticky left: 0, z-index: 11
            </div>
          </div>
          <div>
            <code class="text-meta">.sticky-row-cell</code>
            <div class="text-meta">
              Apply to first-column td — sticky left: 0, z-index: 1,
              font-weight: 600
            </div>
          </div>
        </Stack>
