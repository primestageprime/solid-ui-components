...
const item = (
  name: string,
  overrides?: Record<string, HeatStreamStatus>,
): HeatStreamItem => ({
  name,
  statuses: Object.fromEntries(
    KEYS.map((k) => [k, overrides?.[k] ?? "full"]),
  ) as Record<string, HeatStreamStatus>,
});
...
const allMissing: Record<string, HeatStreamStatus> = Object.fromEntries(
  KEYS.map((k) => [k, "missing"]),
);
const allUnknown: Record<string, HeatStreamStatus> = Object.fromEntries(
  KEYS.map((k) => [k, "unknown"]),
);
...
const XBOX5_1: Record<string, HeatStreamItem[]> = {
  ...
  "2025-11": [
    item("VC-1", fidMissing),
    item("VC-2", fidMissing),
    item("VC-3", fidMissing),
  ],
  "2025-12": [
    item("VC-1", fidMissing),
    item("VC-2", fidMissing),
  ...
  "2026-01": [
    item("VC-1", { ...fidMissing, "FTIR.O": "partial" }),
    item("VC-2", fidMissing),
  ],
  "2026-02": [item("VC-1"), item("VC-2", allUnknown)],
};
...
const XBOX3_2: Record<string, HeatStreamItem[]> = {
  ...
  "2025-10": [
    item("VC-1"),
    item("VC-2", { DP: "partial" }),
    item("VC-3", ftirIMissing),
  ],
  "2025-11": [
    item("VC-1"),
    item("VC-2", { ...ftirIMissing, "FTIR.O": "partial" }),
  ],
  "2025-12": [
    item("VC-1"),
    item("VC-2"),
    item("VC-3"),
    item("VC-4", ftirIMissing),
    item("VC-5"),
  ],
  "2026-01": full(2),
  "2026-02": [item("VC-1"), item("VC-2", allUnknown)],
...
const XBOX5_2: Record<string, HeatStreamItem[]> = {
  "2025-09": [
    item("VC-1"),
    item("VC-2", allMissing),
    item("VC-3", { "FTIR.I": "partial" }),
    item("VC-4"),
  ],
  ...
  "2026-02": [
    item("VC-1"),
    item("VC-2", { FID: "partial" }),
    item("VC-3", allUnknown),
  ],
};
...
export const HeatStreamGridShowcase: Component = () => {
  ...
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Composes HeatStream. Renders a grid table with assets as rows and time
        windows as columns. Each cell contains a compact HeatStream. Click
        cells, row labels, column headers, or the corner to toggle selection.
      </p>
        ...
        <div class="depth2-atoms">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              <div class="depth2-atom__label">string[] — row labels</div>
            </div>
          </div>
          <div class="depth2-atom-group">
            <div class="depth2-atom-group__label">columns</div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">string[] — column headers</div>
            </div>
          </div>
          <div class="depth2-atom-group">
            <div class="depth2-atom-group__label">keys</div>
            <div class="depth2-atom">
              <div class="depth2-atom__label">string[] — HeatStream keys</div>
            </div>
          </div>
          <div class="depth2-atom-group">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              <div class="depth2-atom__label">
                SelectionStore&lt;string&gt; — optional selection control
              </div>
            </div>
          </div>
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              <div class="depth2-atom__label">
                (row, col) =&gt; void — fallback when no selectionStore
              </div>
            </div>
          </div>
        </div>
