...
export const HeatStreamShowcase: Component = () => {
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Owns CSS (HeatStream.css), no component imports. Transposed stream: keys
        flow top-to-bottom (rows), items flow left-to-right (columns, earliest
        left, latest right).
      </p>
        ...
        <div class="depth2-atoms">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              <div class="depth2-atom__label">default / compact</div>
            </div>
          </div>
          <div class="depth2-atom-group">
          ...
          <div class="depth2-atom-group">
            ...
            <div class="depth2-atom">
              <div class="depth2-atom__label">A, B, C, D (customizable)</div>
            </div>
          </div>
        </div>
      </div>
