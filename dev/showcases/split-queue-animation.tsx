...
/* A dedicated harness for watching the SplitQueueList resolve animation: tall
 * cards, a continuous duration knob, and a fixed 10-item queue that starts
 * empty (nothing categorized) so every resolve is a fresh slide across the seam. */
...
export const SplitQueueAnimationShowcase: Component = () => {
  ...
  return (
    <div class="component-section">
      <h2>SplitQueueList — animation</h2>
      <p class="text-meta">
        A dedicated harness for the resolve animation. Tall (120px) cards, a fixed
        queue of 10 transactions that starts <strong>empty</strong> (0 categorized,
        10 to categorize). Resolving a row FLIP-slides it up across the seam and
        repaints from unresolved to resolved styling. Drag the{" "}
