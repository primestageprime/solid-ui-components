...
} from "../../src/components/StatusLight/StatusLight";
...
export const StatusLightShowcase: Component = () => (
  <div class="component-section">
    ...
    <p class="text-meta">
      LED-style indicator dot with optional pulse. Drop next to a label to show
      liveness or alert state. For sparkline-driven liveness, use
    ...
    <div class="example-group">
      ...
      <Row gap="sm" align="center">
        <Stack gap="xs" align="center">
          ...
          <span class="text-meta">sm</span>
        </Stack>
        <Stack gap="xs" align="center">
          <StatusLight variant="success" size="md" />
          <span class="text-meta">md</span>
        </Stack>
        <Stack gap="xs" align="center">
          <StatusLight variant="success" size="lg" />
          <span class="text-meta">lg</span>
        </Stack>
      </Row>
    </div>
