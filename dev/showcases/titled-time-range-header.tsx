...
export const TitledTimeRangeHeaderShowcase: Component = () => {
  return (
    <div class="component-section">
      ...
      <p class="text-meta">
        Owns CSS (TitledTimeRangeHeader.css); no library-component imports. The
        pure `formatDateTimeRange` helper supplies the date-range string. Title
        + optional badge + time range + duration + optional asset chip +
