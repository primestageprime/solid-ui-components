  ...
  return (
    <div class="component-section">
      ...
      <div class="example-group">
        ...
        <NarrowStack>
          <div class="text-meta">
            The old TooltipCell variant is just `openDelay=1000` with the
            `cell` trigger class — downstream Phase 8 inlines this instead of
      ...
      <div class="example-group">
        ...
        <NarrowStack>
          <div class="text-meta">
            Any `TooltipRootProps` field (placement, gutter, etc.) is forwarded
            to Kobalte's Tooltip.Root.
          </div>
          <Row gap="sm">
