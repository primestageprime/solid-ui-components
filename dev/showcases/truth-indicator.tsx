...
} from "../../src/components/TruthIndicator";
  ...
  return (
    <div class="component-section">
      ...
      <div class="example-group">
        ...
        <Row gap="sm" align="center">
          <Stack gap="xs" align="center">
            ...
            <span class="text-meta">value=true</span>
          </Stack>
          <Stack gap="xs" align="center">
            <TruthIndicator value={false} />
            <span class="text-meta">value=false</span>
          </Stack>
        </Row>
      </div>
      ...
      <div class="example-group">
        ...
        <Row gap="sm" align="center">
          <Stack gap="xs" align="center">
            <SmallTruth value={true} />
            <span class="text-meta">sm (12px)</span>
          </Stack>
          <Stack gap="xs" align="center">
            <TruthIndicator value={true} />
            <span class="text-meta">md (16px, default)</span>
          </Stack>
          <Stack gap="xs" align="center">
            <LargeTruth value={true} />
            <span class="text-meta">lg (22px)</span>
          </Stack>
        </Row>
      </div>
