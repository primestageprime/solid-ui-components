...
export const VerticalButtonGroup: Component<ButtonGroupDataProps> =
  createButtonGroup({ orientation: "vertical" });

/** Bordered horizontal group — segmented-control look. */
export const BorderedButtonGroup: Component<ButtonGroupDataProps> =
  createButtonGroup({ bordered: true });
