...
/** Informational alert. */
export const InfoAlert: Component<AlertBoxDataProps> = createAlertBox({
  variant: "info",
});
/** Warning alert. */
export const WarningAlert: Component<AlertBoxDataProps> = createAlertBox({
  variant: "warning",
});
/** Success alert. */
export const SuccessAlert: Component<AlertBoxDataProps> = createAlertBox({
  variant: "success",
});
/** Danger/error alert. */
export const DangerAlert: Component<AlertBoxDataProps> = createAlertBox({
  variant: "danger",
});
...
export const MutedEmptyState: Component<EmptyStateDataProps> = createEmptyState(
  { variant: "muted" },
);
