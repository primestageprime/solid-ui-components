...
describe("allocateHeights — the progression water-fill", () => {
  it("collapses empty sections to their summary line and populated ones shrink-wrap when they fit", () => {
  ...
  it("overflow → the populated sections share the space 1:1:2", () => {
  ...
  it("a section that shrinks under its share hands the surplus to the others", () => {
