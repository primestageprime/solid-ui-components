...
import type { StackedAreaSeriesData } from "../Chart";
...
export const STACKED_TIMELINE_FALLBACK_SIZE = { width: 640, height: 220 } as const;
...
export type StackedTimelineChartOverrides = Pick<
  ...
  "margin" | "xTickFormat" | "yTickFormat"
>;
...
/**
 * Curry the inset and the tick text once per screen. Tick text carries the
 * screen's units ("40h", "2025-Q3"), which a library cannot guess, so there is
 * no shipped variant — the consumer curries its own.
 */
