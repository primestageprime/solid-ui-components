/* SwimlaneChart geometry — routed edge-view computation.
 *
 * Turns visible/collapsed layout edges into one routed SVG path each, handling
 * obstacle-avoiding routing, badge-anchored summary edges, and dedup of the
 * synthetic anchor→summary edges the layout emits. */
import {
