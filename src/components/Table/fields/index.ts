...
export { nameCol, name15Col, name20Col, name25Col, name30Col } from "./name";
export type { NameColOpts } from "./name";
export { identityLinkCol, identityLink15Col, identityLink20Col, identityLink25Col, identityLink30Col } from "./identity-link";
