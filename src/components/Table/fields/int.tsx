...
import { type FieldCol, type FieldGeo, centered, humanize } from "./shared";
...
export const geo: FieldGeo = { minCh: 6, maxCh: 12, css: "12ch" };
...
export const intCol = <T,>(key: keyof T): FieldCol<T> => ({
  id: String(key),
